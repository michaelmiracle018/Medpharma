...
export const VERIFICATION_IDENTITY =
  process.env.EXPO_PUBLIC_VERIFICATION_IDENTITY

export const ENCRYPTION_SECRET_KEY = process.env.EXPO_PUBLIC_SECRET_KEYS
export const ZUSTAND_USER_DATA_STORAGE_KEY = process.env.EXPO_PUBLIC_ZUSTAND_STORAGE_KEY
